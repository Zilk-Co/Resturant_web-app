...
const navGroups: NavGroup[] = [
      ...
      },
      {
        ...
        icon: Smartphone,
        items: [
          { href: "/admin/banners", label: "Banner Management", icon: Monitor },
          { href: "/admin/qr-menu", label: "QR Code Menu", icon: QrCode },
        ],
      },
      {
        title: "Website Only",
        icon: Globe,
        items: [
          { href: "/admin/website-content", label: "Website Content", icon: Layout },
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/admin/orders", label: "Live Orders", icon: ReceiptText },
