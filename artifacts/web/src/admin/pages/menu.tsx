...
const menuItemSchema = z.object({
  ...
  priceSmall: z.coerce.number().nullable().optional(),
  priceMedium: z.coerce.number().nullable().optional(),
  priceLarge: z.coerce.number().nullable().optional(),
              ...
              <Form {...form}>
                ...
                >
                      ...
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Show Small, Medium, and Large price tiers instead of a single price
                          </p>
                        </div>
                        <FormControl>
                          <Switch
                  ...
                  {form.watch("hasSizes") ? (
                    <div className="grid grid-cols-3 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-semibold">Small (Rs)</FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                                {...field}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-semibold">Medium (Rs)</FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                                {...field}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-semibold">Large (Rs)</FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                                {...field}
                              ...
                              <div className="flex flex-col h-full p-2 gap-2">
                                ...
                                <div className="flex flex-col gap-1 mt-auto">
                                  <input
                                    ...
                                    className="w-full text-[10px] border border-input rounded-md px-1.5 py-1 bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/50"
                                  />
                                  <button
                                    type="button"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Callout Note</FormLabel>
                        <FormControl>
                          <Textarea
                            {...field}
                            value={field.value || ""}
                            placeholder="Optional note shown on item detail (e.g. 'Prepared fresh daily')"
                            rows={2}
                          />
                        </FormControl>
                        <p className="text-xs text-muted-foreground">Optional message displayed on the item detail page</p>
                      </FormItem>
                    )}
                  />
