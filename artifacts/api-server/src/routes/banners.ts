...
router.patch("/admin/banners/:id", adminAuth, async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    const mapping: Record<string, string> = {
      title: "title", subtitle: "subtitle", tag: "tag", tagColor: "tag_color",
      gradStart: "grad_start", gradEnd: "grad_end", ctaLabel: "cta_label",
      ctaCat: "cta_cat", imageUrl: "image_url", active: "active", sortOrder: "sort_order",
    };
